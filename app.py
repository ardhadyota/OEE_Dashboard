...
try:
    ...
    header_status = "Gagal Memproses Data Faktor"
    desc_status = f"Terjadi kesalahan saat menghitung defisit faktor: {str(e)}"
    prioritas_text = "Silakan periksa kembali struktur data masukan."    
        st.markdown(
            f"""
